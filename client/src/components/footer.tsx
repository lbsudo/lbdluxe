...
export function Footer() {
    return (
        <>
            ...
            <footer className="w-full flex flex-col items-end justify-center mt-3 static">
                <div className={'h-px bg-gradient-to-r from-transparent via-white to-transparent w-full mb-24 '}/>

                <div
                    className={"mb-12 md:mb-32 mt-0 flex w-full flex-col items-center justify-center"}
                >
                    <Button
                        className={"bg-white text-xl flex flex-row justify-center items-center text-black font-normal px-40  h-10"}
                        variant="bar"
                        onClick={() => {
            ...
            <FaRegCopyright/>
                    ...
                    <ul className={"flex flex-row justify-center items-center gap-4 pt-2"}>
