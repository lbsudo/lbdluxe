...
import {Layers, LibraryBig, PanelTopClose, SquareArrowOutUpRight} from "lucide-react";
        ...
        <>
            <Drawer open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
                <DrawerTrigger asChild>
                    <Button variant="bar" className="text-3xl px-1 font-medium" size={'icon'}
                    ><PanelTopClose size={28} className={'size-8'}/></Button>
                </DrawerTrigger>
