...
import {ControlBarModal} from "@/components/global/navigation/control-bar-modal.tsx";
    ...
    return (
        <>
            <div className="inset-x-0 bottom-0 z-10 mb-12 hidden w-full items-center justify-center md:flex md:fixed">
                <div
                    className={"flex  items-center justify-center rounded-md py-1.5 px-1.5 bg-neutral-700/50 backdrop-blur-xl border border-neutral-500 "}>
                    {/* 🔹 Main nav buttons */}
