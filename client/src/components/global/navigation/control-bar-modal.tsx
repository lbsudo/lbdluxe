    ...
    <>
      <KeyboardTriggeredDialog keyboardShortcut="k" modifierKey="meta">
        <DialogTrigger asChild>
          <Button className="bg-transparent text-xl rounded-md " variant="bar">
            ⌥K
          </Button>
        </DialogTrigger>

        <KeyboardTriggeredDialogContent className=" bg-neutral-700/50 backdrop-blur-xl flex flex-col justify-start items-start rounded-xl h-max w-full max-w-lg">
